...
(function() {
    var VERSION = '@VERSION@',
        ...
        */
        ...
        object_create = Object.create || (function () {
            function F() {}
    ...
    **/
        ...
        /*global YUI_config*/
    YUI = function() {
        var Y         = object_create(proto),
            yuiConfig = (typeof YUI_config !== 'undefined') && YUI_config,
            args      = arguments,
            i, len;

        /**
        Shared data space between YUI instances that is not accessible by the
        global environment.
